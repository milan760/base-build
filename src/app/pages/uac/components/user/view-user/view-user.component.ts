...
export class ViewUserComponent {
  ...
  public UserComponentObject: DynamicTable = {
    ...
    headerAndBodyLoopers: [
      ...
      { thRowspan: 2, thColspan: 1, tdRowspan: 2, tdColspan: 1, isTHactive: 1, isTDactive: 1, THclass: 'text-center text-nowrap', TDclass: 'text-center text-nowrap', spanClass: "", isSortNeeded: 1, defaultIcon: 'fa fa-sort', descIcon: 'fa fa-sort-desc', ascIcon: 'fa fa-sort-asc', THname: 'First Name', TDkey: 'firstName', TDdataType: 'string' },
      { thRowspan: 2, thColspan: 1, tdRowspan: 2, tdColspan: 1, isTHactive: 1, isTDactive: 1, THclass: 'text-center text-nowrap', TDclass: 'text-center text-nowrap', spanClass: "", isSortNeeded: 1, defaultIcon: 'fa fa-sort', descIcon: 'fa fa-sort-desc', ascIcon: 'fa fa-sort-asc', THname: 'Last Name', TDkey: 'lastName', TDdataType: 'string' },
      { thRowspan: 2, thColspan: 1, tdRowspan: 2, tdColspan: 1, isTHactive: 1, isTDactive: 1, THclass: 'text-center text-nowrap', TDclass: 'text-center text-nowrap', spanClass: "", isSortNeeded: 1, defaultIcon: 'fa fa-sort', descIcon: 'fa fa-sort-desc', ascIcon: 'fa fa-sort-asc', THname: 'Mobile No.', TDkey: 'contactNo', TDdataType: 'string' },
      { thRowspan: 2, thColspan: 1, tdRowspan: 2, tdColspan: 1, isTHactive: 1, isTDactive: 1, THclass: 'text-center text-nowrap', TDclass: 'text-center text-nowrap', spanClass: "", isSortNeeded: 1, defaultIcon: 'fa fa-sort', descIcon: 'fa fa-sort-desc', ascIcon: 'fa fa-sort-asc', THname: 'Email ID', TDkey: 'emailId', TDdataType: 'string' },

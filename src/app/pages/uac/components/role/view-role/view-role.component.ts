...
export class ViewRoleComponent {
  ...
  public RoleComponentObject: DynamicTable = {
    ...
    headerAndBodyLoopers: [
      ...
      { thRowspan: 2, thColspan: 1, tdRowspan: 2, tdColspan: 1, isTHactive: 1, isTDactive: 1, THclass: 'text-center text-nowrap', TDclass: 'text-center text-nowrap', spanClass: "", isSortNeeded: 1, defaultIcon: 'fa fa-sort', descIcon: 'fa fa-sort-desc', ascIcon: 'fa fa-sort-asc', THname: 'Role Id', TDkey: 'roleId', TDdataType: 'number' },
      { thRowspan: 2, thColspan: 1, tdRowspan: 2, tdColspan: 1, isTHactive: 1, isTDactive: 1, THclass: 'text-center text-nowrap', TDclass: 'text-center text-nowrap', spanClass: "", isSortNeeded: 1, defaultIcon: 'fa fa-sort', descIcon: 'fa fa-sort-desc', ascIcon: 'fa fa-sort-asc', THname: 'Role Name', TDkey: 'roleName', TDdataType: 'string' },
      { thRowspan: 2, thColspan: 1, tdRowspan: 2, tdColspan: 1, isTHactive: 1, isTDactive: 1, THclass: 'text-center text-nowrap', TDclass: 'text-center text-nowrap', spanClass: "", isSortNeeded: 1, defaultIcon: 'fa fa-sort', descIcon: 'fa fa-sort-desc', ascIcon: 'fa fa-sort-asc', THname: 'Role Code', TDkey: 'roleCode', TDdataType: 'string' },
      { thRowspan: 2, thColspan: 1, tdRowspan: 2, tdColspan: 1, isTHactive: 1, isTDactive: 1, THclass: 'text-center text-nowrap', TDclass: 'text-center text-nowrap', spanClass: "", isSortNeeded: 1, defaultIcon: 'fa fa-sort', descIcon: 'fa fa-sort-desc', ascIcon: 'fa fa-sort-asc', THname: 'Status', TDkey: 'status.statusCode', TDdataType: 'object' },
